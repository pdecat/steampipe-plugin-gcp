		...
		HydrateConfig: []plugin.HydrateConfig{
			{
				...
				Tags: map[string]string{"service": "resourcemanager", "action": "ProjectsGetAccessApprovalSettings"},
			},
			{
				Func: getProjectAncestors,
				Tags: map[string]string{"service": "resourcemanager", "action": "ProjectsGetAncestry"},
			},
		},
